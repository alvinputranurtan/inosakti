...
<title>Pembayaran | InoSakti - Engineering &amp; Technology Solutions</title>
...
<style type="text/tailwindcss">
        ...
        @layer components {
            ...
            .payment-method-label {
                @apply flex items-center justify-between p-4 cursor-pointer hover:bg-slate-50 dark:hover:bg-slate-700/50 transition-colors rounded-xl border border-transparent;
            }
...
<button class="w-full bg-primary hover:bg-blue-800 text-white font-bold py-4 rounded-xl transition-all shadow-lg shadow-primary/20 flex items-center justify-center gap-2 group" onclick="window.location.href='qris-payment.php'">
                        Bayar Sekarang
