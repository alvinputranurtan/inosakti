    ...
    <section class="animate-slide-up stagger-3">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            <div class="service-card group bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-6 rounded-2xl shadow-sm hover:shadow-md transition-all duration-300">
                ...
                <h3 class="font-bold text-lg text-slate-900 dark:text-white mb-2 leading-tight">Image Processing</h3>
                <p class="text-slate-600 dark:text-slate-400 text-sm leading-relaxed">Advanced algorithms for enhancing, analyzing, and extracting data from digital images.</p>
            </div>
            ...
            <div class="service-card group bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-6 rounded-2xl shadow-sm hover:shadow-md transition-all duration-300">
                ...
                <h3 class="font-bold text-lg text-slate-900 dark:text-white mb-2 leading-tight">Object Detection</h3>
                <p class="text-slate-600 dark:text-slate-400 text-sm leading-relaxed">Real-time identification and localization of multiple objects within video streams.</p>
            </div>
            ...
            <div class="service-card group bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-6 rounded-2xl shadow-sm hover:shadow-md transition-all duration-300">
                ...
                <h3 class="font-bold text-lg text-slate-900 dark:text-white mb-2 leading-tight">Deep Learning Model Development</h3>
                <p class="text-slate-600 dark:text-slate-400 text-sm leading-relaxed">Custom neural network architecture design tailored to solve complex business problems.</p>
            </div>
            ...
            <div class="service-card group bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-6 rounded-2xl shadow-sm hover:shadow-md transition-all duration-300">
                ...
                <h3 class="font-bold text-lg text-slate-900 dark:text-white mb-2 leading-tight">Predictive Analytics</h3>
                <p class="text-slate-600 dark:text-slate-400 text-sm leading-relaxed">Forecasting future trends and behaviors using historical data and statistical modeling.</p>
            </div>
            ...
            <div class="service-card group bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-6 rounded-2xl shadow-sm hover:shadow-md transition-all duration-300">
                ...
                <h3 class="font-bold text-lg text-slate-900 dark:text-white mb-2 leading-tight">Computer Vision Industrial System</h3>
                <p class="text-slate-600 dark:text-slate-400 text-sm leading-relaxed">Automated quality inspection and guidance systems for manufacturing environments.</p>
            </div>
            ...
            <div class="service-card group bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-6 rounded-2xl shadow-sm hover:shadow-md transition-all duration-300">
                ...
                <h3 class="font-bold text-lg text-slate-900 dark:text-white mb-2 leading-tight">AI Edge Inference System</h3>
                <p class="text-slate-600 dark:text-slate-400 text-sm leading-relaxed">Deploying AI models directly onto hardware devices for low-latency processing.</p>
            </div>
            ...
            <div class="service-card group bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-6 rounded-2xl shadow-sm hover:shadow-md transition-all duration-300">
                ...
                <h3 class="font-bold text-lg text-slate-900 dark:text-white mb-2 leading-tight">Intelligent Automation System</h3>
                <p class="text-slate-600 dark:text-slate-400 text-sm leading-relaxed">Combining AI and RPA to automate complex end-to-end workflows and tasks.</p>
            </div>
            ...
            <div class="service-card group bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-6 rounded-2xl shadow-sm hover:shadow-md transition-all duration-300">
                ...
                <h3 class="font-bold text-lg text-slate-900 dark:text-white mb-2 leading-tight">AI-based Monitoring &amp; Surveillance</h3>
                <p class="text-slate-600 dark:text-slate-400 text-sm leading-relaxed">Smart security solutions with behavior analysis and automated threat detection.</p>
            </div>
            ...
            <div class="service-card group bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-6 rounded-2xl shadow-sm hover:shadow-md transition-all duration-300">
                ...
                <h3 class="font-bold text-lg text-slate-900 dark:text-white mb-2 leading-tight">Machine Learning Pipeline Development</h3>
                <p class="text-slate-600 dark:text-slate-400 text-sm leading-relaxed">Building end-to-end MLOps pipelines from data ingestion to model deployment.</p>
            </div>
            ...
            <div class="service-card group bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-6 rounded-2xl shadow-sm hover:shadow-md transition-all duration-300">
                ...
                <h3 class="font-bold text-lg text-slate-900 dark:text-white mb-2 leading-tight">Dataset Preparation &amp; Labeling</h3>
                <p class="text-slate-600 dark:text-slate-400 text-sm leading-relaxed">High-quality data annotation services for training robust and accurate AI models.</p>
            </div>
            ...
            <div class="service-card group bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-6 rounded-2xl shadow-sm hover:shadow-md transition-all duration-300">
                ...
                <h3 class="font-bold text-lg text-slate-900 dark:text-white mb-2 leading-tight">AI Model Optimization &amp; Deployment</h3>
                <p class="text-slate-600 dark:text-slate-400 text-sm leading-relaxed">Quantization and pruning techniques to speed up performance on production servers.</p>
            </div>
            ...
            <div class="service-card group bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-6 rounded-2xl shadow-sm hover:shadow-md transition-all duration-300">
                ...
                <h3 class="font-bold text-lg text-slate-900 dark:text-white mb-2 leading-tight">Decision Support System</h3>
                <p class="text-slate-600 dark:text-slate-400 text-sm leading-relaxed">AI-driven platforms that provide data-backed recommendations for strategic decisions.</p>
            </div>
        </div>
    </section>
