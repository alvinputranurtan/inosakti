    ...
    <section class="animate-slide-up stagger-3">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            <div class="service-card group">
                ...
                <h3 class="font-bold text-lg text-slate-900 dark:text-white mb-2">Network Planning &amp; Installation</h3>
                <p class="text-slate-600 dark:text-slate-400 text-sm leading-relaxed">
                    End-to-end strategy and deployment of high-performance network infrastructures.
                </p>
            </div>
            ...
            <div class="service-card group">
                ...
                <h3 class="font-bold text-lg text-slate-900 dark:text-white mb-2">Infrastructure Network Engineering</h3>
                <p class="text-slate-600 dark:text-slate-400 text-sm leading-relaxed">
                    Designing resilient core systems for enterprise-grade data handling.
                </p>
            </div>
            ...
            <div class="service-card group">
                ...
                <h3 class="font-bold text-lg text-slate-900 dark:text-white mb-2">Wireless Communication System Design</h3>
                <p class="text-slate-600 dark:text-slate-400 text-sm leading-relaxed">
                    Architecture of wireless networks optimized for coverage and capacity.
                </p>
            </div>
            ...
            <div class="service-card group">
                ...
                <h3 class="font-bold text-lg text-slate-900 dark:text-white mb-2">RF Design &amp; Simulation</h3>
                <p class="text-slate-600 dark:text-slate-400 text-sm leading-relaxed">
                    Advanced modeling and simulation of radio frequency environments.
                </p>
            </div>
            ...
            <div class="service-card group">
                ...
                <h3 class="font-bold text-lg text-slate-900 dark:text-white mb-2">Antenna Design &amp; Fabrication</h3>
                <p class="text-slate-600 dark:text-slate-400 text-sm leading-relaxed">
                    Custom antenna solutions tailored for specific frequency and gain requirements.
                </p>
            </div>
            ...
            <div class="service-card group">
                ...
                <h3 class="font-bold text-lg text-slate-900 dark:text-white mb-2">RF Measurement &amp; Characterization</h3>
                <p class="text-slate-600 dark:text-slate-400 text-sm leading-relaxed">
                    Precise testing and validation of RF components and system performance.
                </p>
            </div>
            ...
            <div class="service-card group">
                ...
                <h3 class="font-bold text-lg text-slate-900 dark:text-white mb-2">RF Pre-Compliant Testing</h3>
                <p class="text-slate-600 dark:text-slate-400 text-sm leading-relaxed">
                    Assessing devices for regulatory standards before final certification.
                </p>
            </div>
            ...
            <div class="service-card group">
                ...
                <h3 class="font-bold text-lg text-slate-900 dark:text-white mb-2">Spectrum Analysis &amp; Optimization</h3>
                <p class="text-slate-600 dark:text-slate-400 text-sm leading-relaxed">
                    Maximizing frequency efficiency and minimizing interference.
                </p>
            </div>
            ...
            <div class="service-card group">
                ...
                <h3 class="font-bold text-lg text-slate-900 dark:text-white mb-2">EMI/EMC Evaluation Support</h3>
                <p class="text-slate-600 dark:text-slate-400 text-sm leading-relaxed">
                    Ensuring electromagnetic compatibility and interference shielding.
                </p>
            </div>
            ...
            <div class="service-card group">
                ...
                <h3 class="font-bold text-lg text-slate-900 dark:text-white mb-2">High Throughput Data Communication</h3>
                <p class="text-slate-600 dark:text-slate-400 text-sm leading-relaxed">
                    Optimizing bandwidth for massive data transmission and low latency.
                </p>
            </div>
            ...
            <div class="service-card group">
                ...
                <h3 class="font-bold text-lg text-slate-900 dark:text-white mb-2">IoT Communication Protocol Engineering</h3>
                <p class="text-slate-600 dark:text-slate-400 text-sm leading-relaxed">
                    Developing low-power, wide-area protocols for interconnected devices.
                </p>
            </div>
        </div>
    </section>
