...
<head>
  ...
  <title>Login Admin | InoSakti</title>
...
<body class="min-h-screen bg-slate-100 font-sans">
  <div class="min-h-screen grid lg:grid-cols-2">
    <div class="hidden lg:flex bg-gradient-to-br from-blue-900 to-slate-900 text-white p-12 items-end">
      <div>
        <h1 class="text-4xl font-extrabold leading-tight">InoSakti Admin Panel</h1>
        <p class="mt-4 text-blue-100 max-w-md">Kelola konten, pembelajaran, e-commerce, dan operasional internal dari satu dashboard.</p>
      </div>
    </div>
    <div class="flex items-center justify-center p-6">
      <div class="w-full max-w-md bg-white rounded-2xl shadow-sm border border-slate-200 p-7">
        <h2 class="text-2xl font-extrabold text-slate-800">Masuk Admin</h2>
        <p class="text-sm text-slate-500 mt-1">Gunakan akun dari tabel <code>users</code>.</p>
        ...
        <form method="post" class="mt-6 space-y-4">
          ...
          <div>
            ...
            <input type="email" name="email" class="w-full rounded-xl border-slate-300" placeholder="admin@inosakti.com" required>
          </div>
          <div>
